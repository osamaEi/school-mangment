...
<div class="container-fluid px-4">
    <h1 class="mt-4">{{__('Edit Student')}}</h1>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('Adminstudent.update', $student->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <select class="form-select @error('country') is-invalid @enderror" 
                                                ...
                                                <option value="USA" {{ old('country', $student->country) == 'USA' ? 'selected' : '' }}>{{__('United States')}}</option>
                                                <option value="UK" {{ old('country', $student->country) == 'UK' ? 'selected' : '' }}>{{__('United Kingdom')}}</option>
                                                <option value="Canada" {{ old('country', $student->country) == 'Canada' ? 'selected' : '' }}>{{__('Canada')}}</option>
                                            </select>
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('Adminstudent.index') }}" class="btn btn-secondary">{{__('Cancel')}}</a>
                        </div>
                    </form>
                </div>
            </div>
